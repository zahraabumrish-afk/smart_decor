...
class DesignRequestUploadScreen extends StatefulWidget {
  ...
  @override
  State<DesignRequestUploadScreen> createState() => _DesignRequestUploadScreenState();
}
...
class _DesignRequestUploadScreenState extends State<DesignRequestUploadScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        const Text(
            'Upload one clear photo of your room to start\ndesigning it your way',
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: _hasImage ? Colors.transparent : Colors.black.withOpacity(0.18),
    ...
    // ✅ زرين (Camera / Gallery) نفس ستايلك
    Row(
    mainAxisAlignment: MainAxisAlignment.center,
    children: [
    _SmallBeigeButton(
    ...
    Padding(
    padding: const EdgeInsets.symmetric(horizontal: 18),
    child: // زر المتابعة (نفس ستايل الأزرار وبحجم أصغر)
    SizedBox(
      width: 220,
      height: 46,
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor: canContinue ? const Color(0xFFF3C9A8) : Colors.white.withOpacity(0.12),
          foregroundColor: canContinue ? const Color(0xFF3B2A1E) : Colors.white38,
          elevation: 0,
